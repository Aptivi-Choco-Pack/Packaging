...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.2.0.6/0.2.0.6-bin.zip"
$shacheck   = "8201FF50BD70376AD2C6A1CF53736774CCAFEB642792FD40C83C83AA8B3A298F"
