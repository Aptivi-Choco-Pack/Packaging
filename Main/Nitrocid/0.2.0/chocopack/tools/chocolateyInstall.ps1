...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.2.0.1/0.2.0.1-bin.zip"
$shacheck   = "35BEAF038D4263846170C43E2E595590C2FF6D2A14AC47EDCFD09ACCB079B63F"
