...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.2.0/0.2.0.0-bin-lite.zip"
$shacheck   = "E96D4C666C9329A19495C01FAEA0EAC8D364AC45DB1CC93C99819DE4B416B94A"
