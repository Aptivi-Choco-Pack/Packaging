...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.2.14/0.1.2.14-bin.zip"
$shacheck   = "72A224BF7006732900E6111C83B1597C22AF33C88A2597C40C47919174717A7F"
