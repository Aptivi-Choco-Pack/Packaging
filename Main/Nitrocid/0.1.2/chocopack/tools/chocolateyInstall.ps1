...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.2.15/0.1.2.15-bin.zip"
$shacheck   = "BE3E4A81322B03477662EDBEE2D858B5CB286F9CD2174786CC0DB83C85FD39C0"
