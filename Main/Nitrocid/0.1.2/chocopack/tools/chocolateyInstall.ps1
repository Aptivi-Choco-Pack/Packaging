...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.2/0.1.2.0-bin.zip"
$shacheck   = "0707896B81395596007E3F0E34A6B8F8E12FD04A629409C6EBC49AEDDA3335CA"
