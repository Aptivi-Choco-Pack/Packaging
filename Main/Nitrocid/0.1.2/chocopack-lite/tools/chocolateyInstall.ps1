...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.2.6/0.1.2.6-bin-lite.zip"
$shacheck   = "94B34E2DEC6F988970140FCB11B7AB8A9D8A1D61A7A04843C8CF0FE344EFA544"
