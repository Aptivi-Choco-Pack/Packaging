...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.2.14/0.1.2.14-bin-lite.zip"
$shacheck   = "B70118E1B2411594BC9E8741574400EFF87EF042B94576A473B7910B7FF2A1FE"
