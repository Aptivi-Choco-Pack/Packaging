...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.2.2/0.1.2.2-bin-lite.zip"
$shacheck   = "3857DB93F54A51D4DEC3924078AA3D7C872A3B5126142160FDACC86A2A9CAAC1"
