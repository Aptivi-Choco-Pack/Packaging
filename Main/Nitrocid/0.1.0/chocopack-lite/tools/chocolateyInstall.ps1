...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.61/0.1.0.61-bin-lite.zip"
$shacheck   = "8915A668ACD6DDAAD299EE9A54A1A9DABC73B6FD5BC0307DC281ADCC73047F94"
