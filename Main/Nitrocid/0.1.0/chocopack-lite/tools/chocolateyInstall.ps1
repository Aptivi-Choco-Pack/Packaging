...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.65/0.1.0.65-bin-lite.zip"
$shacheck   = "325F7F2BF5BDA936F7A6B3613DD21E498891FED1DAF1358D80819310BFBF5F76"
