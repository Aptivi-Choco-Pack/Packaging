...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.24/0.1.0.24-bin-lite.zip"
$shacheck   = "19515142f2a83aa31d99dcd5ebfd691af9c93b4dbe6ce7d082c8b5a78d9b6e8a"
