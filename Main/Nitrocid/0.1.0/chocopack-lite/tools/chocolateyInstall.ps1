...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.23/0.1.0.23-bin-lite.zip"
$shacheck   = "f6e378356d8f72b63dbf74db8ce662ebb58b53b3a9a15160ff0a4e62714ba5ad"
