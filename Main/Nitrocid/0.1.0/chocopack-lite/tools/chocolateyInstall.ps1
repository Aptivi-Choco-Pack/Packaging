...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.40/0.1.0.40-bin-lite.zip"
$shacheck   = "DC9812303C71C4A5DD185B3E86524418F01A0543C2188D98C39E687576EC4C57"
