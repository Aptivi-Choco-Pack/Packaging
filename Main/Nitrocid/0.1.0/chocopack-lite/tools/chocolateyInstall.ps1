...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.44/0.1.0.44-bin-lite.zip"
$shacheck   = "C97D5392E4231702148E6D3E17C66E31F8C6C30AD8FB380547C4C08FA5283CAB"
