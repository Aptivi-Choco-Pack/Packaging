...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.74/0.1.0.74-bin-lite.zip"
$shacheck   = "1B3DE0D028C7B166DFE7D55C1D9B7D2937CFFA75298F864BDA8167C18145BF0E"
