...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.45/0.1.0.45-bin-lite.zip"
$shacheck   = "519B5E21E7004B84505374CE6685660A7E0C990840C44B87B6B111442E6EB9F2"
