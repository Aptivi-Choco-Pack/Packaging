...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.55/0.1.0.55-bin-lite.zip"
$shacheck   = "93925df1c41bd47da0374a4b898289bbec9cf4ba891211ba2e1c2e1ae6d1f0f5"
