...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.28/0.1.0.28-bin.zip"
$shacheck   = "ca25cbf5a2315d9ebaf24a5a15296964ddcd69e22784fa706003ee987399bb47"
