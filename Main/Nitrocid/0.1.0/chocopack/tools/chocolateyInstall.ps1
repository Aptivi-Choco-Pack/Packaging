...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.73/0.1.0.73-bin.zip"
$shacheck   = "D7E8EA9639A4DBB1255007448283949457C672AC361AF5F1F2FF626828C1E707"
