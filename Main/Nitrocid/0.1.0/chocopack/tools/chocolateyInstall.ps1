...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.55/0.1.0.55-bin.zip"
$shacheck   = "2b4c52586421fabd788764629d9b34a35c912e36b37884b12bb04802cf92e5e2"
