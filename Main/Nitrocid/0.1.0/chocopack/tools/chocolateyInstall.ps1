...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.30/0.1.0.30-bin.zip"
$shacheck   = "FB0D9F786F1E2839901721880503D47C5AF88C2754014FC412EDC6C6D6196B7A"
