...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.68/0.1.0.68-bin.zip"
$shacheck   = "00BC3FBFC5D2E7FB7F03C271B9A58D370386F7CBA44634F2115B3259B9A3CDA4"
