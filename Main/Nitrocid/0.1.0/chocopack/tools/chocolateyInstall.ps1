...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.18/0.1.0.18-bin.zip"
$shacheck   = "1d38b192ed2bd25d3c8b8708448f9916300e0fc6deb659aba0121fac41460e9f"
