...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.39/0.1.0.39-bin.zip"
$shacheck   = "3870CB511B6116386C13E05D1B398333F4226B8D3458986CE1725FD15BC311F1"
