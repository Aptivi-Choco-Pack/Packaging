...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.70/0.1.0.70-bin.zip"
$shacheck   = "FBCF846CB81CF7191114E366ABF5F9457C1ED2CF3AA6448516DB1A8301649C94"
