...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/Nitrocid/releases/download/v0.1.0.72/0.1.0.72-bin.zip"
$shacheck   = "2EC6A7BA9A97DD327FFF85C1579A023FBB910975F7621F21E3FE79CCC263715C"
