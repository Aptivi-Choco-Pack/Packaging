...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.24/0.1.1.24-bin-lite.zip"
$shacheck   = "CD60433480E5624556F53182CACF90944029AD69CC173AD9E7AAA03C518F742C"
