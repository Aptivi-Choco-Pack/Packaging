...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.23/0.1.1.23-bin-lite.zip"
$shacheck   = "DCA7169AF1B1BFCD53F91B8AA6F31AEA3D5B0D6D20D77B7B827B653F4FE787BE"
