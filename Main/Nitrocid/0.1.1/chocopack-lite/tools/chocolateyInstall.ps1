...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.32/0.1.1.32-bin-lite.zip"
$shacheck   = "4A00E33C65DE9B32461D4F29A3CAD2A0671241027C5B3874863CCA821C6C85F9"
