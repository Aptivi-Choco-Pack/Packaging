...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.15/0.1.1.15-bin.zip"
$shacheck   = "f5cfd3f84d909f3316dd1761cd9f65d5abc0f6bcc6270be73db7b96633be64f3"
