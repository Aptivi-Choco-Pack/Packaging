...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.7/0.1.1.7-bin.zip"
$shacheck   = "ec86bfd0f83904a98b7de4a50b60b2e3e3ae2f0d3f6a812f2b1829a0bc39514a"
