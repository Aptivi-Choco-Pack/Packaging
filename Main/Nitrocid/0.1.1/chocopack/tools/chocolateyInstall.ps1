...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.22/0.1.1.22-bin.zip"
$shacheck   = "2387e4ad25a4ef7e8757c171bab692f79370bfb5984bd1dbfa9b89996354fa0e"
