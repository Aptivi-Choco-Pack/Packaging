...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.26/0.1.1.26-bin.zip"
$shacheck   = "6C62E1737B4C85EDA7F8B173AD0A8F93D0A77CEEF92AA20617C406D11B7206DB"
